...
describe("events", function () {
    it("should exist", function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            chai_1.expect(event_1.events).to.exist;
            return [2 /*return*/];
        });
    }); });
    it("should be a function", function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            chai_1.expect(event_1.events).to.be.a("function");
            return [2 /*return*/];
        });
    }); });
    it("should create an group of events", function () { return __awaiter(_this, void 0, void 0, function () {
        var group;
        return __generator(this, function (_a) {
            group = event_1.events({
                alpha: new event_1.Event(),
                beta: new event_1.Event(),
                delta: new event_1.Event(),
            });
            chai_1.expect(group).to.be.a("object");
            chai_1.expect(group).to.have.property("alpha");
            chai_1.expect(group.alpha).to.be.an.instanceOf(event_1.Event);
            chai_1.expect(group).to.have.property("beta");
            chai_1.expect(group.beta).to.be.an.instanceOf(event_1.Event);
            chai_1.expect(group).to.have.property("delta");
            chai_1.expect(group.delta).to.be.an.instanceOf(event_1.Event);
            return [2 /*return*/];
        });
    }); });
    it("should have concat", function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            chai_1.expect(event_1.events).to.have.property("concat");
            chai_1.expect(event_1.events.concat).to.be.a("function");
            return [2 /*return*/];
        });
    }); });
    it("should concat groups", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            groupA = event_1.events({
                alpha: new event_1.Event(),
                beta: new event_1.Event(),
            });
            groupB = event_1.events({
                delta: new event_1.Event(),
                gamma: new event_1.Event(),
            });
            combined = event_1.events.concat(groupA, groupB);
            chai_1.expect(combined).to.be.a("object");
            chai_1.expect(combined).to.have.property("alpha");
            chai_1.expect(combined.alpha).to.be.an.instanceOf(event_1.Event);
            chai_1.expect(combined).to.have.property("beta");
            chai_1.expect(combined.beta).to.be.an.instanceOf(event_1.Event);
            chai_1.expect(combined).to.have.property("delta");
            chai_1.expect(combined.delta).to.be.an.instanceOf(event_1.Event);
